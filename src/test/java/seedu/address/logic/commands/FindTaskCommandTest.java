...
public class FindTaskCommandTest {
    private final Model model = new ModelManager(getTypicalTaskList(), new UserPrefs());
    private final Model expectedModel = new ModelManager(getTypicalTaskList(), new UserPrefs());
